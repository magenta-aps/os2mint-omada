...
def test_omada_user_to_manual(raw_omada_user_manual: RawOmadaUser) -> None:
    """Test that a manual user, parsed as a normal one, can be converted to manual."""
    user = OmadaUser.parse_obj(raw_omada_user_manual)
    ManualOmadaUser(**user.dict())


def test_omada_pseudo_infinity(raw_omada_user: RawOmadaUser) -> None:
